...
<html lang="en">
    <head>
        ...
        <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/jquery-ui.min.js"></script>
            <!-- Engine -->
            <script src="engine/global.js?buildTime=<?=filemtime('./engine/global-gcc.js')?>"></script>
            <script src="engine.js?buildTime=<?=filemtime('./engine-gcc.js')?>"></script>
            <script src="engine/editor.js?buildTime=<?=filemtime('./engine/editor-gcc.js')?>"></script>
            <script src="engine/minimap.js?buildTime=<?=filemtime('./engine/minimap-gcc.js')?>"></script>
